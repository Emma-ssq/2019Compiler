...
/*
%token  ADD  SUB  MUL  DIV  LT  LTE 
%token GT  GTE  EQ  NEQ  ASSIN  SEMICOLON 
%token COMMA  LPARENTHESE  RPARENTHESE  LBRACKET 
%token RBRACKET  LBRACE  RBRACE  ELSE  IF  INT 
%token RETURN  VOID  WHILE  ARRAY 
